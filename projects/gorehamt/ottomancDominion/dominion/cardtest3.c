...
int main(){
    ...
    printf("\n------Testing Great Hall Card Implementation------\n");

    /*Test 1: Verify that the current player receives exactly one card.*/
    printf("\nTesting that current player's hand size increases by exactly 0 cards after great hall card is played (+1 b/c great hall played, -1 b/c great hall was discarded, for a total of 0 extra cards).\n");
    ...
    /*Test 2: Verify that the current player receives exactly 1 more actions*/
    printf("\nTesting that current player's number of actions increases by exactly 1 after great hall card is played.\n");
